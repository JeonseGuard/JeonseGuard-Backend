...
class RegionCodeCsvParserImplTest {
    ...
    void parseRegionCodeTest() {
        ...
        String csvContent = """
                ...
                1111010100,서울특별시,종로구,청운효자동,,1,1999.1.1,,1111010000
                """;
        ...
        assertThat(regionCode.getCreatedDate()).isEqualTo(LocalDate.of(1999, 1, 1));
    ...
    void parseRegionCodeFailTest() {
        ...
        String invalidCsv = """
            ...
            종로구,청운효자동,,1,1999.1.1,,1111010000
            """;
        InputStream input = new ByteArrayInputStream(invalidCsv.getBytes(StandardCharsets.UTF_8));
