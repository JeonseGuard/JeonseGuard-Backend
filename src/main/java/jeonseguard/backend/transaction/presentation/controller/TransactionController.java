...
public class TransactionController {
    ...
    public ResponseEntity<List<TransactionJeonseApartmentResponse>> getTransactionJeonseHistoryForApartment(@RequestBody TransactionJeonseAddressRequest request) {
    ...
    public ResponseEntity<List<TransactionJeonseOfficetelResponse>> getTransactionJeonseHistoryForOfficetel(@RequestBody TransactionJeonseAddressRequest request) {
