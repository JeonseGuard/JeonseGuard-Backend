...
public class BoardController {
    ...
    @GetMapping("/{category}")
    public ResponseEntity<Page<PostResponse>> getPosts(@PathVariable String category,
                                                       Pageable pageable) {
    ...
    public ResponseEntity<PostInfoResponse> getPost(@AuthenticatedUser Long userId,
    ...
    public ResponseEntity<CreatePostResponse> createPost(@AuthenticatedUser Long userId,
                                                         @PathVariable String category,
    ...
    public ResponseEntity<Void> updatePost(@AuthenticatedUser Long userId,
                                           @PathVariable Long postId,
                                           @PathVariable String category,
    ...
    public ResponseEntity<CreateCommentResponse> createComment(@AuthenticatedUser Long userId,
                                                               @PathVariable Long postId,
                                                               @PathVariable String category,
                                                               @Valid @RequestBody CreateCommentRequest request) {
        return ResponseEntity.ok(boardFacade.createComment(userId, postId, category, request));
    }

    @Operation(summary = "댓글 수정", description = "댓글을 수정합니다.")
    @PatchMapping("/comments/{commentId}")
    public ResponseEntity<Void> updateComment(@AuthenticatedUser Long userId,
